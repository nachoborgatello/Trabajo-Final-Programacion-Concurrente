...
public class Main {
    public static void main(String[] args) {
            ...
            // Hora de inicio
            Date start = new Date();
            System.out.println("Se inició el programa: " + formatter.format(start));
            ...
            Date end = new Date();
            System.out.println("Se finalizó el programa: " + formatter.format(end));
    }
    ...
    private static Proceso[] getProcesos(int cantMaxima, Monitor monitor) {
        ...
        int[] tiempos = {
                ...
                20,    // Filtro 1
                20,    // Filtro 2
                10,    // Redimensionador 1
                10,    // Redimensionador 2
                10     // Exportador
        };
